...
for f in list(__const_file.keys()):
    __shallow = __shallowinfo(
        __const_file[f]["shallow"]["isshallow"],
        __const_file[f]["shallow"]["iname"],
        __const_file[f]["shallow"]["coef"],
    )
    __sat = __satinfo(
        __const_file[f]["sat"]["deldood"],
